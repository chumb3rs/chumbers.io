...
heroImage: https://res.cloudinary.com/df6vf0noc/image/upload/v1763181777/hero-images/sangharsh-lohakare-8o_LkMpo8ug-unsplash_qnfbn5.jpg
category: Maths
project: ''
series: undefined
description: >-
...
![An example graph. Note that the edge connecting vertices $$a$$ and $$d$$ would be labelled $$ad$$ for convenience.](https://res.cloudinary.com/df6vf0noc/image/upload/v1670223733/graph%20theory%20x%20genome/ql_af433a35935ae1397cb34d2584e51b96_l3_yrj1yh.png)
...
![Two graphs - which is Hamiltonian or Eulerian? Neither? Both?](https://res.cloudinary.com/df6vf0noc/image/upload/v1670223793/graph%20theory%20x%20genome/ql_799dbdf8ff9b36995001699e13cbaa81_l3_sn2lsm.png)
...
![The $$4\times 4$$ grid graph. Find the Hamiltonian cycle](https://res.cloudinary.com/df6vf0noc/image/upload/v1670223852/graph%20theory%20x%20genome/ql_f840dba93718160b05a821e5d2b5ceec_l3_ww3up0.png)
...
![Modelling the Königsberg bridges as a graph](https://res.cloudinary.com/df6vf0noc/image/upload/v1670042920/graph%20theory%20x%20genome/Koenigsberg_bridges_i5votg.jpg)
...
![Left: The incoming and outgoing edges of any vertex $$v$$ can be paired up. Right: A path (green) can be constructed from a walk by deleting any loops (red).](https://res.cloudinary.com/df6vf0noc/image/upload/v1670046395/graph%20theory%20x%20genome/ql_0e5fdd83965aa01548786951fb278a20_l3_i4jcuv.png)
...
The start and end vertices of the trail <Highlight>must be the two vertices with odd degree</Highlight>.
...
So, due to the second assumption above, given a particular fragment $$f_i$$, the very next base in the original sequence $$\mathcal{S}$$ <Highlight>has to come from a fragment $$f_{j}$$ that is adjacent to $$f_i$$</Highlight>. Using the above example, since $$f_2, f_1$$ are adjacent, we would extend $$f_1$$ to a length of 6 by using the final $$C$$ of $$f_2$$, yielding $$AAGTCC$$.
...
![Construction of fragment graph for Hamiltonian paths](https://res.cloudinary.com/df6vf0noc/image/upload/v1670216111/graph%20theory%20x%20genome/ql_7d9e889982d94720d299416a5c2a3dd6_l3_nv6tga.png)

But with the Eulerian approach detailed by Pevzner et. al:

![Construction of fragment graph for Eulerian trails](https://res.cloudinary.com/df6vf0noc/image/upload/v1670217551/graph%20theory%20x%20genome/ql_c5c7b5bfcd1a1e73eb3bd49a525e3b36_l3_n4zw2v.png)
